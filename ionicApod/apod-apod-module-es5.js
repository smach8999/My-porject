...
var ApodService = /** @class */ (function () {
    function ApodService(http, ngApodConfig) {
        this.http = http;
        this.ngApodConfig = ngApodConfig;
        this.url = "https://api.nasa.gov/planetary/apod?api_key=" + this.ngApodConfig.key;
    }
    ApodService.prototype.getApod = function (date) {
        return this.http.get(this.url + "&date=" + date);
    };
    ApodService.ctorParameters = function () { return [
...
var ApodPageModule = /** @class */ (function () {
    function ApodPageModule() {
    }
...
var ApodPage = /** @class */ (function () {
    function ApodPage(apodService, route) {
        this.apodService = apodService;
        this.route = route;
    }
    ApodPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            if (params['date']) {
                _this.getApod(params['date']);
                // }else{
                ...
                _this.getApod(date.toISOString().slice(0, 10));
            }
        });
    };
    ApodPage.prototype.randomDate = function (start, end) {
        var date = new Date(start.getTime() + Math.random() * (end.getTime() - start.getTime()));
        return new Date((date.getTime() - date.getTimezoneOffset() * 60000)).toISOString().slice(0, 10);
    };
    ApodPage.prototype.getApod = function (date) {
        var _this = this;
        this.apodService.getApod(date)
            .subscribe(function (result) {
            _this.apod = result;
            _this.date = _this.randomDate(new Date(2019, 10, 20), new Date());
        });
    };
    ApodPage.ctorParameters = function () { return [
...
//# sourceMappingURL=apod-apod-module-es5.js.map